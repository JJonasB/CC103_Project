...
--
-- Host: 127.0.0.1
-- Generation Time: May 09, 2025 at 12:04 AM
...
(2, 2, 2, '2025-04-01', '2025-04-02', '2025-04-28', 'Issued'),
(3, 3, 3, '2025-04-28', '2025-04-29', '2025-04-28', 'Issued'),
(4, 3, 3, '2025-04-28', '2025-04-30', '2025-04-28', 'Returned'),
(5, 3, 3, '2025-04-29', '2025-04-28', '2025-04-29', 'Returned'),
(6, 3, 1, '2025-04-29', '2025-04-30', '2025-04-29', 'Returned'),
(7, 4, 1, '2025-04-29', '2025-04-30', '2025-04-29', 'Returned'),
(8, 3, 3, '2025-05-09', '2025-05-11', '2025-05-09', 'Returned');
...
--
-- Dumping data for table `maintenance_reports_tbl`
--

INSERT INTO `maintenance_reports_tbl` (`ReportID`, `ToolID`, `IssueDescription`, `ReportDate`, `Status`) VALUES
(1, 2, '2', '2025-05-09', 'Pending'),
(2, 3, 'Something wrong', '2025-05-09', 'Pending');
...
(2, 'Goofy', 'New', 3, 'Local Storage', 'Issued'),
(3, 'Shovel', 'New', 2, 'Goofy', 'Available'),
(4, 'Rake', 'New', 1, 'Backrooms', 'Available');
...
(3, 'jonasbalante', 'goofy', 'jonas balante', 'jonasbalante', '912', 'Male', 'yes', 1);
